...
use mylib::common::net::{RequestMessage, read_request_message_from_stream};

/**
* server_functions handles parsing the input from a client, and calling the respective server command
**/

pub fn handle_client(stream: TcpStream, server_port: &u64, node_ips: &Vec<Ipv4Addr>, hashtable: &mut Hashtable, msg: RequestMessage) {
...
pub fn accept_client(server_port: &u64, node_ips: &Vec<Ipv4Addr>, hashtable: &mut Hashtable) {
